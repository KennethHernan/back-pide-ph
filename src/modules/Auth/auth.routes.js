...
import { createUser, createAudit,changeDniReniec,deleteDniReniec, createDniReniec, seachID, getAllUsers, getAllDniReniec , signin, verifyToken, logout, changeAll, getAllAudit, changeUserRol, deleteUser, sendHeartbeat, requestPasswordReset, resetPassword } from "./controller.js";
